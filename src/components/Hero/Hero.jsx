...
import BiryaniImg1 from "../../assets/Vegetarian-paradise-biryani.png";
import BiryaniImg2 from "../../assets/mughlai-biryani.png";
import BiryaniImg3 from "../../assets/biryani.png";
        ...
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              <p className="text-sm ">
              Welcome to Spicy Corner Biryani Center, where every grain tells a story and each bite is a flavorful journey! 
              </p>
              <div>
